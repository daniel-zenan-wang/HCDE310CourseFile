...
def flickrREST(baseurl='https://api.flickr.com/services/rest',
        ...
        api_key = '0bdcd11c42c20d46162b0a323f10146e',
        format = 'json',
        params = {},
        printurl = False
        ):
...
def lookupweather(loc):
    ...
    key = "16a53b04c881810e47f44f85a5aee8f5"
...
def makePhotoURL(pd):
    ...
    id = pd['id']
    secret = pd['secret']
    return "https://farm" + str(farm_id) + ".staticflickr.com/" + str(server_id) + "/" + str(id) + "_" + str(secret) + "_o.(jpg|gif|png)"
